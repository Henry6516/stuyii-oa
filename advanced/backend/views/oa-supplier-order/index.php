        ...
        <div class="row">
            <div class="col-sm-1">
                <div class="btn-group">
                    ...
                    <button type="button" class="btn lots-action btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        'columns' => [
            ...
            [
                ...
                'buttons' => [
                    ...
                    'pay' => function ($url) {
                        return "<li><a href='#' data-url=$url  class='payment-act payment-mod' data-toggle='modal' data-target='#payment-modal'>付款</a></li>";
                    },
