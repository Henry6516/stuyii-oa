        ...
        $(function () {
                $.ajax({
                    ...
                    success:function (data) {
                      ...
                      art_char_line('art-per-day-num',data);
                    }
                });
            }); 
...
<div class="site-index">
    ...
    <div class="row">
        ...
        <button id="selectall" data-flag="1">全不选</button>
    </div>
    <div class="row">
        <div id="art-per-day-num" style="width: 1600px;height:580px;" class="col-lg-12"></div>
        <input id="selectall-art" type="button" value="全不选" flag="1"/>
    </div>
...
//                    borderRadius:5,
    ...
    <script>
        function char_line(id, row_data) {
            ...
            var data = eval("(" + row_data + ")");
            var salername, value, CreateDate;
            ...
            var selectArr1 = myChart1.getOption().legend.data;
            if(id == 'per-day-num') {
    ...
    <script>
        function art_char_line(id, row_data) {
...
//                    },
            ...
            var selectArr = myChart2.getOption().legend.data;
            if(id == 'art-per-day-num') {
                $('#selectall-art').click(function () {
